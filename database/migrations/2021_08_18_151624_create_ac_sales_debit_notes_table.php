...
class CreateAcSalesDebitNotesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ac_sales_debit_notes', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ac_sales_debit_notes');
    }
}
