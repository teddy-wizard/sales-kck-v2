...
class CreateAcArDebitNoteDtlsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ac_ar_debit_note_dtls', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('customerId');
            $table->bigInteger('arDebitNoteId');
    ...
    {
        Schema::dropIfExists('ac_ar_debit_note_dtls');
    }
}
