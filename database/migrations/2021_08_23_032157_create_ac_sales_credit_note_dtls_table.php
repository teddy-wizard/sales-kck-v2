...
class CreateAcSalesCreditNoteDtlsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ac_sales_credit_note_dtls', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('customerId');
            $table->bigInteger('cnId');
    ...
    {
        Schema::dropIfExists('ac_sales_credit_note_dtls');
    }
}
